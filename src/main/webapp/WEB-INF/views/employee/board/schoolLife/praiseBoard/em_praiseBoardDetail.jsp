...
<body>
			...
			<br>
				<div align="right" style="margin: 0 auto; width:88.5%;">
					...
					<c:if test="${sessionScope.loginUser.memberId == b.memberId}">
						...
						<button onclick="em_freeBoardList()">목록</button>
					</div>
				</div>
	...
	<script>
		function em_freeBoardList(){
			location.href="em_praiseBoardList.bo";
		}
		...
		function deleteBoard() {
			...
			location.href="em_deletepraiseBoard.bo?boardNo="+boardNo;
		}
		
		function updateBoard(){
			var boardNo = ${b.boardNo};			
			
			location.href="em_showUpdatepraiseBoard.bo?boardNo="+boardNo;
		}
