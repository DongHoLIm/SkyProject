...
<body>
	<div id="wrapper">
		<div id="main">
			...
			<br>
			<form action="em_praiseBoardInsert.bo?memberId=${sessionScope.loginUser.memberId}&writer=${writerInfo.memberName}&writeDept=${writerInfo.edeptName}" method="post" enctype="multipart/form-data">
