...
<body>
	<div id="wrapper">
		<div id="main">
			...
			<table style="width: 88.5%; margin: 0 auto;">
				...
				<tr>
					<td colspan="6"><button onclick="em_freeBoardList()">목록으로</button>
				</tr>
			</table>
		</div>
		<div>
	...
	<script>
		function em_freeBoardList(){
			location.href="em_freeBoardList.bo";
		}
		...
		function deleteBoard() {
			...
			location.href="em_deletefreeBoard.bo?boardNo="+boardNo;
		}
		
		function updateBoard(){
			var boardNo = ${b.boardNo};			
			
			location.href="em_showUpdatefreeBoard.bo?boardNo="+boardNo;
		}
