...
<body>
	<div id="wrapper">
		<div id="main">
			...
			<br>
			<form action="em_acNoticeInsert.bo?memberId=${sessionScope.loginUser.memberId}&writer=${writerInfo.memberName}&writeDept=${writerInfo.edeptName}" method="post" enctype="multipart/form-data">
