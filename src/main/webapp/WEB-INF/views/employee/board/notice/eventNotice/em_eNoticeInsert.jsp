...
<body>
	<div id="wrapper">
		<div id="main">
			...
			<br>
			<form action="em_eNoticeInsert.bo?memberId=${sessionScope.loginUser.memberId}&writer=${writerInfo.memberName}&writeDept=${writerInfo.edeptName}" method="post" enctype="multipart/form-data">
				<table style="width: 88.5%; margin: 0 auto;">
					...
					<tr>
						...
						<td width="100px;">
							<input type='text' class='datepicker-here' data-language='kr' id="dateInput" name="startDate"/>
						</td>
						<th style="text-align: center;">종료일시</th>
						<td width="100px;">
							<input type='text' class='datepicker-here' data-language='kr' id="dateInput" name="endDate"/>
						</td>
						<th style="text-align: center;">게시기한</th>
						<td width="100px;">
							<input type='text' class='datepicker-here' data-language='kr' id="deadLine" name="deadLine"/>
						</td>											
					</tr>
					<tr>
	...
	<script>
		function writeCancel(){
			...
			location.href = "em_eNoticeList.bo";
		}
