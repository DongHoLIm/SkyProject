	...
	<div id="wrapper">
		<div id="main">
			<div class="inner">
				...
				<form action="goLectureAbolitionRegistration.em" method="post">
						...
						<tbody>
							<c:forEach var="LectureOpen" items="${ subjectList }">
								...
								<tr>
									...
									<td style="text-align: center;"><button type="button" class="submitBtn">폐지</button></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
			...
			<div class="pagingArea">
			  <ul class="pagination" style="justify-content: center; cursor: pointer;">
				...
				<c:if test="${pi.currentPage > 1}">
					<c:url var="blistBack" value="subjectAbolition.em">
				...
				<c:forEach var="p" begin="${pi.startPage}" end="${pi.endPage}">
					...
					<c:if test="${p ne pi.currentPage}">
						<c:url var="blistCheck" value="subjectAbolition.em">
				...
				<c:if test="${pi.currentPage < pi.maxPage }">
					<c:url var="blistEnd" value="subjectAbolition.em">
						<c:param name="currentPage" value="${pi.currentPage + 1}"/>
					</c:url>
	...
	<script>
		...
		$(function(){
			$(".submitBtn").click(function(){
				...
				location.href="goLectureAbolitionRegistration.em?subCode="+$subCode;
			})
		})
	</script>
</body>
