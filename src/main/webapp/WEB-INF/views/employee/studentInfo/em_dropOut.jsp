		...
		$.ajax({
			...
			success:function(data){
				...
				$(".enrollSpan").click(function(){
					...
					if(confirm("[신청번호 : " + dropNo + "] 자퇴 완료 처리 하시겠습니까?") == true){
						$.ajax({
							url:"em_DropOutEnroll.si",
							type:"POST",
							data:{
								"dropNo":dropNo,
								"studentNo":studentNo
				...
				$(".rejectSpan").click(function(){
					...
					if(confirm("[신청번호 : " + dropNo + "] 자퇴 반려 처리 하시겠습니까?") == true){
						var rejectReason = prompt("반려사유를 입력하세요.");
						
						$.ajax({
							url:"em_DropOutReject.si",
							type:"POST",
							data:{
								"dropNo":dropNo,
		...
		$.ajax({
			...
			success:function(data){
				...
				for(var i = 0; i < data.list.length; i++){
					...
					$td9.text(data.list[i].rejectReason);
