      ...
      <div id="main">
		...
		<h4 id="basic">휴학신청 상세 내용</h4>
            ...
            <table class="basicinfo">
               ...
               <tr>
               	<th width="20%">입대일자</th>
               	<td>${soSelect.enlistmentDate }</td>
               	<th width="20%">전역예정 일자</th>
               	<td>${soSelect.demobilizationDate }</td>
               </tr>               
               <tr>
               	<th width="20%"><span style="position: absolute; top: 390px;">서류</span></th>
               	<td colspan="3">
               		<img src="resources/docFiles/${img }" width="90%">
               	</td>
               </tr>
