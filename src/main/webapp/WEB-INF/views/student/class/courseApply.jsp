...
<script>
	function selectGwamok(){	
		$(".tableList3").show();
		$(".tableList1").hide();

	}
	function selectPreliminaryCourseApplyList(){
		$(".tableList1").show();
		$(".tableList3").hide();
	}
...
<body>
	...
	<table>
		<tr>
			<td>
				<button id="btn" onclick="selectPreliminaryCourseApplyList();">예비수강신청목록</button>
				<button id="btn" onclick="selectGwamok();">과목조회</button>
			</td>
		</tr>
	</table>
	<table class="tableList3" width="100%" style="display:none;">
			<tbody>
				<tr id="choice">
					<td>
						<span> &nbsp;&nbsp;&nbsp;<b>카테고리</b> : 
		...
		<table class="tableList1" width="100%" style="display:none;">
		<tbody>
			<tr id="choice">
				<td>
					<span> &nbsp;&nbsp;&nbsp;<b>카테고리</b> : 
					...
					<span class="btn4" onclick="gwamokSearch();" id="search_btn" style="background:red">조 회</span>
					<span class="btn5" onclick="professorSearch();" id="search_btn" style="background:red; display:none;">조 회</span>
					<span class="btn6" onclick="completeSearch();" id="search_btn" style="background:red; display:none;">조 회</span>
					&nbsp;&nbsp;&nbsp;
