...
<body>
	<td><span> &nbsp;&nbsp;&nbsp;<b>카테고리</b> : <select
			...
			style="background-color: #FFD9EC;">
	...
	</span> <!-- 개설강좌 --> <span id="choice0" name="choice0"> <span>
				<strong>학과</strong> : <select name="allMajor" id="allMajor"
				class="Layer1" onchange="javascript:setIsu();">
				...
				class="Layer1" onchange="javascript:setLecture();"><option
					...
					<option value="P">평생</option></select> &nbsp;&nbsp;&nbsp; <strong>학년</strong>
				: <select name="allHakyun" id="allHakyun" class="Layer1"
				onchange="javascript:setLecture();">
					<option value="ALL" selected="">* 전체 *</option>
					<option value="1">1학년</option>
					<option value="2">2학년</option>
					<option value="3">3학년</option>
					<option value="4">4학년</option>
			</select> &nbsp;&nbsp;&nbsp; <strong>과목</strong> : <select name="allLecture"
				id="allLecture" class="Layer1" style="background-color: #FFD9EC;">
	...
	</span> <!-- 과목조회 --> <span id="choice1" name="choice1" style="display: none">
			<span> <span class="ui-widget"> <label for="gwamok_nm">조회
						: </label> <input type="text" name="gwamok_nm" id="gwamok_nm" size="20"
	...
	</span> <!-- 교수조회 --> <span id="choice2" name="choice2" style="display: none">
			<span> <span class="ui-widget"> <label for="prof_nm">조회
						: </label> <input type="text" name="prof_nm" id="prof_nm" size="20"
					value="교수명을 입력하세요."
					onkeydown="if(event.keyCode == 13) {search_prof_nm(); return false;}"
					onblur="search_prof_nm();" onfocus="click_prof_nm();"> 교수 :
					<select name="allProf" id="allProf" class="Layer1"
					style="width: 150;" onchange="javascript:setProfLecture();"></select>
					&nbsp;&nbsp;&nbsp; 과목 : <select name="profLecture" id="profLecture"
					class="Layer1" style="width: 200; background-color: #FFD9EC;"></select>
					&nbsp;&nbsp;&nbsp;
			</span>
		</span>
	</span> <span> <span class="btn red on" onclick="javascript:search();"
			name="search_btn" id="search_btn"> 조 회 </span> <span
			name="waiting_btn" id="waiting_btn" style="display: none">&nbsp;&nbsp;<img
