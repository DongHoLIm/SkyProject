...
<body>
	<div id="wrapper">
		<div id="main">
			...
			<br>
			<form action="st_praiseBoardInsert.bo?memberId=${sessionScope.loginUser.memberId}&writer=${writerInfo.memberName}&writeDept=${writerInfo.edeptName}" method="post" enctype="multipart/form-data">
	...
	<script>
		function writeCancel(){
			...
			location.href = "st_praiseBoardList.bo";
		}
