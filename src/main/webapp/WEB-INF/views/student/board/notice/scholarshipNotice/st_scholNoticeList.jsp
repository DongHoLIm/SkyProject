		...
		$.ajax({
			...
			success:function(data){
				...
				$(".sNoticeTitle").click(function(){
					...
					location.href="st_sNoticeDetail.bo?boardNo=" + boardNo;
				});
			}
		});
	});
		...
		<div id="main">
			...
			<table style="width: 88.5%; text-align: center; margin: 0 auto;">
				<tr>
					...
					<td><input style="display: inline-block; width: 80%;" type="text" name="searchValue" id="searchValue" placeholder="내용을 입력해주세요"></td>
					<td><input style="display: inline-block;" type="submit" value="검색" onclick="searchsNotice()"></td>
				</tr>
			</table>
			<br>
			<br>
