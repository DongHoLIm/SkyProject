			...
			<form class="ba">
				<table class="basicinfo">
					...
					<table class="basicinfo" id="Change">
						<tr>
							<h4 id="basic">학적 변동 조회</h4>
						</tr>
						<thead>
							<tr>
								<th style="text-align: center">변동 시작일</th>
								<th style="text-align: center">변동 종료일</th>
								<th style="text-align: center">변동 내용</th>
								<th style="text-align: center">변동 사유</th>
								<th style="text-align: center">접수 일자</th>
							</tr>
						<thead>
						<tobody>
						<tr>
