...
<body>
	...
	<script>
		$("#goListBtn").click(function(){
			var memberId = $(this).parent().parent().children().eq(0).val();
		...
		function updateSystemQuestion(){
			...
			location.href = "pro_showSystemQuestionUpdate.bo?questionNo=" + questionNo;
		}
		...
		function deleteSystemQuestion(){
			...
			location.href = "pro_SystemQuestionDelete.bo?questionNo=" + questionNo + "&memberId=" + memberId;
		}
	</script>
</body>
</html>